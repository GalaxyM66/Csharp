...
{
    public partial class AddModfiyPriceGoodunifyForm : Form
    {
        ...
        public AddModfiyPriceGoodunifyForm()
        {
            InitializeComponent();         
           
        }

        private void AddModfiyPriceGoodunifyForm_Load(object sender, EventArgs e)
        {
