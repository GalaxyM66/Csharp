...
{
    public partial class AddModfiyPriceGoodunifyForms : Form
    {
        ...
        public AddModfiyPriceGoodunifyForms()
        {
            InitializeComponent();
        }

        private void AddModfiyPriceGoodunifyForms_Load(object sender, EventArgs e)
        {
        ...
        private void btnModfiy_Click(object sender, EventArgs e)
        {
            ...
            if (!Defaltdept.Equals(cbDefaultdept.SelectedValue.ToString()))
            {

                Form_confirm fconfirm = new Form_confirm();
                fconfirm.Message = "选择部门不是默认部门，是否确认！";
                fconfirm.ShowDialog();
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string starttime = dtpStarttime.Value.ToString("yyyy-MM-dd");
            string endtime = dtpEndtime.Value.ToString("yyyy-MM-dd");
            dao.PScmGoodunifyInsert(int.Parse(Properties.Settings.Default.COMPID), int.Parse(Properties.Settings.Default.OWNERID), int.Parse(cbDefaultdept.SelectedValue.ToString()), int.Parse(Waredictinfo.Goodid), double.Parse(txtPrc.Text.ToString()), double.Parse(txtPrice.Text.ToString()), int.Parse(SessionDto.Empid), double.Parse(txtCostprc.Text.ToString()), double.Parse(txtCostprice.Text.ToString()), double.Parse(txtCostrate.Text.ToString()), starttime, endtime, double.Parse(txtBottomprc.Text.ToString()), double.Parse(txtBottomprice.Text.ToString()), "01", retinfo);
            if (retinfo.num == "1")
            {
        ...
        private void txtBottomprice_KeyUp(object sender, KeyEventArgs e)
        {
            Dictionary<string, string> sqlkeydict = new Dictionary<string, string>();
            sqlkeydict.Add("Pic", txtPrc.Text.ToString());
            sqlkeydict.Add("Costprc", txtCostprc.Text.ToString());
        ...
        private void txtBottomprc_KeyUp_1(object sender, KeyEventArgs e)
        {
            Dictionary<string, string> sqlkeydict = new Dictionary<string, string>();
            sqlkeydict.Add("Pic", txtPrc.Text.ToString());
            sqlkeydict.Add("Costprc", txtCostprc.Text.ToString());
